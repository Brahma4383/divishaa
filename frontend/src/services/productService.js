...
const TRENDING = [
  {
    id: "p1",
    category: "women",
    brand: "Divishaa Label",
    name: "Emerald Draped Saree Gown",
    price: 6499,
    originalPrice: 9999,
    rating: 4.8,
    reviewCount: 212,
  ...
  },
  {
    ...
    category: "women",
    brand: "Zara",
    name: "Beige Tailored Blazer Dress",
    price: 3899,
    originalPrice: 5299,
    rating: 4.6,
    reviewCount: 98,
...
const NEW_ARRIVALS = [
  {
    ...
    badge: "new",
    image:
      "https://images.unsplash.com/photo-1551803091-e20673f15770?q=80&w=500&auto=format&fit=crop",
  },
  {
    id: "n2",
    category: "women",
  ...
  },
  {
    ...
    category: "women",
    brand: "AJIO",
    name: "Terracotta Wrap Kurta",
    price: 1699,
    rating: 4.5,
    badge: "new",
    image:
      "https://images.unsplash.com/photo-1583391733956-6c78276477e2?q=80&w=500&auto=format&fit=crop",
  },
  {
    id: "n4",
    category: "women",
    brand: "Divishaa Label",
    name: "Ivory Organza Cape",
    price: 3499,
    rating: 4.8,
    badge: "new",
    image:
      "https://images.unsplash.com/photo-1585487000160-6ebcfceb0d03?q=80&w=500&auto=format&fit=crop",
  },
  {
    id: "n5",
    category: "women",
    ...
    badge: "new",
    image:
      "https://images.unsplash.com/photo-1591369822096-ffd140ec948f?q=80&w=500&auto=format&fit=crop",
  },
  {
    id: "n6",
    category: "men",
...
const BEST_SELLERS = [
  {
    ...
    category: "women",
    brand: "Divishaa Label",
    name: "Signature Zari Border Saree",
    price: 8499,
    rating: 4.9,
    badge: "bestseller",
    image:
      "https://images.unsplash.com/photo-1583391733981-8b3f2d6f5a2e?q=80&w=600&auto=format&fit=crop",
  },
  {
    id: "b2",
    category: "men",
    brand: "Nike",
    name: "Classic Everyday Joggers",
    price: 2499,
    rating: 4.6,
    badge: "bestseller",
    image:
      "https://images.unsplash.com/photo-1552902019-ebcd97aa9aa0?q=80&w=600&auto=format&fit=crop",
  },
  {
    id: "b3",
    category: "men",
  ...
  },
  {
    ...
    category: "women",
    brand: "Puma",
    name: "Studio Sculpt Crop Set",
    price: 1999,
    rating: 4.4,
    badge: "bestseller",
    image:
      "https://images.unsplash.com/photo-1600185365483-26d7b3d5c7a1?q=80&w=600&auto=format&fit=crop",
  },
];
...
const BRANDS = [
  ...
  { id: "br5", name: "Zara" },
  { id: "br6", name: "H&M" },
  { id: "br7", name: "Roadster" },
  { id: "br8", name: "Allen Solly" },
  { id: "br9", name: "Divishaa Label" },
];
...
const REVIEWS = [
  {
    ...
    rating: 5,
    purchasedProduct: "Gold Thread Lehenga Set",
    text: "The embroidery detail is beyond anything I expected online. Felt truly custom-made.",
    customerImage:
  ...
  },
  {
    ...
    rating: 5,
    purchasedProduct: "Emerald Draped Saree Gown",
    text: "Fit like a dream and the fabric quality is genuinely premium. Worth every rupee.",
    customerImage:
  ...
  },
  {
    ...
    rating: 4,
    purchasedProduct: "Ivory Organza Cape",
    text: "Delivery was quick and the packaging alone felt like a luxury unboxing experience.",
    customerImage:
  ...
  },
  {
    ...
    customerName: "Riya D.",
    rating: 5,
    purchasedProduct: "Onyx Velvet Blazer",
    text: "Compliments every time I wear it. The tailoring is sharp and the fit is flawless.",
    customerImage:
...
const HERO_SLIDES = [
  {
    ...
    subtitle:
      "Up to 50% off handcrafted silhouettes. Discover the season's most coveted drapes.",
    image:
  ...
  },
  {
    ...
    highlight: "Elegance",
    subtitle:
      "Limited edition eveningwear, hand-finished with gold thread embroidery.",
    image:
  ...
  },
  {
    ...
    highlight: "Edit",
    subtitle: "Bespoke bridal ensembles crafted for your most memorable day.",
    image:
      "https://images.unsplash.com/photo-1520367445093-50dc08a59d9d?q=80&w=1600&auto=format&fit=crop",
    ctaPrimary: "Shop Now",
    ctaSecondary: "Explore Collection",
  },
];
...
const ALL_PRODUCTS = Array.from(
  new Map(
    [...TRENDING, ...NEW_ARRIVALS, ...BEST_SELLERS, ...MORE_PRODUCTS].map(
      (p) => [p.id, p],
    ),
  ).values(),
);
