    ...
    <div className="flex h-screen overflow-hidden bg-ivory">
      ...
      <div className="relative hidden h-full lg:block lg:w-1/2">
        ...
        <div className="absolute bottom-16 left-12 text-ivory">
          ...
          <p className="mt-1 font-serif text-4xl font-medium italic text-gold-soft">it's about being remembered.</p>
          <p className="mt-5 text-xs uppercase tracking-[0.3em] text-ivory/60">— Divishaa.couture</p>
        </div>
      </div>
      ...
      <div className="flex w-full flex-col overflow-y-auto lg:w-1/2">
        <div className="mx-auto w-full max-w-md flex-1 px-8 py-12 sm:px-16">
          ...
          <h1 className="text-center font-serif text-[28px] font-medium text-ink">Welcome Back</h1>
          <p className="mb-8 mt-1.5 text-center text-sm text-gray">Sign in to your account to continue</p>
          ...
          <form onSubmit={handleSubmit} noValidate className="space-y-5">
            ...
            <div>
              <div className="mb-2 flex items-center justify-between">
                <label htmlFor="password" className="block text-xs font-medium uppercase tracking-widest text-ink">
                  Password
                </label>
                <Link to="/forgot-password" className="text-xs text-gold transition hover:text-ink">
                  Forgot password?
                </Link>
              </div>
              <input
            ...
            <div className="flex items-center gap-2 pt-1">
              ...
              />
              <label htmlFor="remember" className="cursor-pointer text-xs text-gray">
          ...
          <p className="mb-4 mt-10 text-center text-sm text-gray">
            ...
            <Link to="/register" className="font-medium text-ink underline underline-offset-2 transition hover:text-gold">
              Create one
            </Link>
          </p>
        </div>
