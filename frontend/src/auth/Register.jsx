      ...
      <div className="flex w-full flex-col overflow-y-auto lg:w-1/2">
        <div className="mx-auto w-full max-w-md flex-1 px-8 py-12 sm:px-16">
          ...
          <p className="mb-8 mt-1.5 text-center text-sm text-gray">
            Join the atelier — exclusive offers await
          </p>
          ...
          <form onSubmit={handleSubmit} noValidate className="space-y-4">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                />
                {errors.firstName && (
                  <p className="mt-1 text-xs text-maroon">{errors.firstName}</p>
                )}
              </div>
              <div>
                <label
                ...
                />
                {errors.lastName && (
                  <p className="mt-1 text-xs text-maroon">{errors.lastName}</p>
                )}
              </div>
            </div>
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  className={`w-full border bg-transparent px-4 py-3 pr-10 text-sm text-ink placeholder:text-gray-light transition focus:outline-none ${
                    errors.password
                      ? "border-maroon"
                      : "border-gold-soft focus:border-ink"
                  }`}
                ...
                <button
                  ...
                  className="absolute right-3 top-1/2 -translate-y-1/2 text-gray/70 hover:text-ink"
                >
                  {showPassword ? (
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 24 24" fill="none" stroke="currentColor">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M13.875 18.825A10.05 10.05 0 0112 19c-6 0-9-5.5-9-7a9.97 9.97 0 012.286-3.78M15 12a3 3 0 11-6 0 3 3 0 016 0z" />
            ...
            <div>
              ...
              {errors.role && (
                <p className="mt-1 text-xs text-maroon">{errors.role}</p>
              )}
            </div>
            ...
            <div>
              <div className="flex items-start gap-3 pt-1">
                ...
                <label
                  htmlFor="agreeTerms"
                  className="cursor-pointer text-xs leading-relaxed text-gray"
                >
                  I agree to the{" "}
                  <Link
                    to="/terms"
                    className="text-ink underline underline-offset-2 transition hover:text-gold"
                  >
                    Terms of Service
                  </Link>{" "}
                  and{" "}
              ...
              {errors.agreeTerms && (
                <p className="mt-1 text-xs text-maroon">{errors.agreeTerms}</p>
              )}
            </div>
      ...
      <div className="relative hidden h-full lg:block lg:w-1/2">
        ...
        <div className="absolute right-8 top-8 max-w-xs rounded-sm bg-ink/60 px-6 py-5 text-right text-ivory backdrop-blur-sm">
          ...
          {[
            ...
            <div
              key={benefit}
              className="mb-3 flex items-center justify-end gap-2.5 last:mb-0"
            >
